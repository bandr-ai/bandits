...
def test_an_explicitly_empty_declaration_is_a_toolset_of_none() -> None:
    """A source saying the agent was offered nothing has said something."""
    assert parse_toolset([]) == ()
