...
from bandits.emulate.retrieve import RetrievedExample, support_level
...
class ProposedTransition(Contract):
    ...
    """Raw validation errors from the failed parse, for emulation."""
...
def validate_instance(
    ...
    try:
        ...
        raise WorldModelError(
            "schema validation needs the 'emulate' extra: uv sync --extra emulate"
        ) from exc
