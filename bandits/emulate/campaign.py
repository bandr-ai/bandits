"""One reproducible emulate campaign, from fidelity gate to candidate reports."""
...
from bandits.emulate.fidelity import FidelityReport, gate
...
from bandits.emulate.report import CapabilityReport, Comparison, build_capability_report
from bandits.emulate.rollout import (
    Budget,
    Candidate,
    run_rollout,
)
from bandits.emulate.world import ToolWorldPredictor, UserPolicyPredictor
