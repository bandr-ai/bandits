...
from bandits.emulate.retrieve import RetrievalQuery, RetrievedExample, retrieve
...
def render_agentic_action(context: AWMRuntimeContext) -> str:
    from bandits.emulate.world import render_action
...
def build_agentic_tool_world_predictor(
    *,
    ...
    try:
        ...
        from bandits.emulate.world import WorldModelError
...
def step_agentic_tool_world(
    ...
    *,
    ...
    """
    from bandits.emulate.world import ProposedTransition, _coerce, _CoerceFailure
...
def _null_unsupported_observation_fields(
    ...
    *,
    ...
    """
    from bandits.emulate.world import ProposedCallOutcome
